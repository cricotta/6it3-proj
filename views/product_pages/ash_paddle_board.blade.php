    ...
    <div style="max-width: 768px;" class=" mt-12 grid sm:grid-cols-1 md:grid-cols-2 justify-center border border-gray-300 rounded-md shadow-lg">
        <div class="flex m-4 justify-center text-xl">
            ...
            <div style="min-width: 383px; max-width: 385px; " class="ml-4">
                ...
                <div class="m-4">
                    <img style="height: 350px; width: 350px" id="imageBox" class="rounded-md" src="/images/paddle_board.jpg" alt=""/>
                </div>

                <div class="flex justify-center">
                    <img class="rounded-md opacity-60 op h-24 w-24 m-4" src="/images/paddle_board.jpg" onclick="myFunction(this)"/>
                    <img class="rounded-md opacity-60 op h-24 w-24 m-4" src="/images/paddle_board2.jpg" onclick="myFunction(this)"/>
        ...
        <div style="min-width: 383px; max-width: 385px;" class="justify-center m-4">
            <form action="/AddToCart" method="POST">
                @csrf
            <div>
                <h1 class="mt-4 italic text-2xl"> Ash Paddle Board</h1>
                ...
                <div>
                    ...
                    <input name="product_id" type="number" value="6" class="hidden">
