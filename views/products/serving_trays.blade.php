    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6">
        <div class="flex justify-center">
            <div class=" rounded-lg shadow-lg bg-white max-w-sm">
                <a href="#!">
                    <img class="rounded-t-lg" src="/images/paddle_board.jpg" alt="fix spelling"/>
                </a>
                <div class="p-6">
                    <h5 class="text-gray-900 text-2xl font-medium mb-2">Ash Paddle Board</h5>
                    <a href="/product_pages/ash_paddle_board">
