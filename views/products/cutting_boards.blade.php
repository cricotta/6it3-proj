        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6">
            <div class="flex justify-center">
                <div class=" rounded-lg shadow-lg bg-white max-w-sm">
                    <a href="#!">
                    <img class="rounded-t-lg" src="/images/mapple_end_grain.jpg" alt="fix spelling"/>
                    </a>
                    <div class="p-6">
                    <h5 class="text-gray-900 text-2xl font-medium mb-2">Mapple End Grain</h5>
            ...
            <div class="flex justify-center">
                <div class=" rounded-lg shadow-lg bg-white max-w-sm">
                    ...
                    <div class="p-6">
                    <h5 class="text-gray-900 text-2xl font-medium mb-2">Walnut End grain </h5>
            ...
            <div class=" flex justify-center">
                <div class="rounded-lg shadow-lg bg-white max-w-sm">
                    <a href="">
                    <img class="rounded-t-lg" src="/images/cherry_face_grain.jpg" alt=""/>
                    </a>
                    <div class="p-6">
                    <h5 class="text-gray-900 text-2xl font-medium mb-2">Cherry Face Grain</h5>
